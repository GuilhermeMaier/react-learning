export const shorterWestminsterCatechism = {
  question1: {
    id: 1,
    question: "PERGUNTA 1. Qual é o fim principal do homem?",
    answer:
  ...
  question3: {
    ...
    references: "Ref. Jo 5.39; 20.31; Sl 119.105; Rm 15.4; 1Co 10.11.",
  },
  question4: {
    id: 4,
    question: "PERGUNTA 4. Quem é Deus?",
    answer:
  ...
  question5: {
    id: 5,
    question: "PERGUNTA 5. Há mais de um Deus?",
    answer: "R. Há só um Deus, o Deus vivo e verdadeiro.",
    references: "Ref. Dt 6.4; 1Co 8.4; Jr 10.10; Jo 17.3.",
  },
  question6: {
    id: 6,
    question: "PERGUNTA 6. Quantas pessoas há na Divindade?",
    answer:
  ...
  question7: {
    id: 7,
    question: "PERGUNTA 7. Que são os decretos de Deus?",
    answer:
  ...
  question8: {
    id: 8,
    question: "PERGUNTA 8. Como executa Deus os seus decretos?",
    answer:
      "R. Deus executa os seus decretos nas obras da criação e da providência.",
    references: "Ref. Ap 4.11; Dn 4.35; Is 40.26; 14.26-27; 46.9-11; At 4.24.",
  },
  question9: {
    id: 9,
    question: "PERGUNTA 9. Qual é a obra da criação?",
    answer:
      "R. A obra da criação é aquela pela qual, Deus fez todas as coisas do nada, no espaço de seis dias, e tudo muito bem.",
    references: "Ref. Gn 1; Hb 11.3; Sl 33.9; Gn 1.31.",
  },
  question10: {
    id: 10,
    question: "PERGUNTA 10. Como criou Deus o homem?",
    answer:
    ...
    references: "Ref. Gn 1.27-28; Cl 3.10; Ef 4.24; Rm 2.14-15; Sl 86-8.",
  },
  question11: {
    id: 11,
    question: "PERGUNTA 11. Quais são as obras da providência de Deus?",
    answer:
    ...
    references: "Ref. Sl 145.17; 104.10-24; Hb 1.3; Mt 10.29-30; Os 2.6.",
  },
  question12: {
    id: 12,
    question:
    ...
    references: "Ref. Gl 3.12; Gn 2.17.",
  },
  question13: {
    id: 13,
    question:
    ...
    references: "Ref. Rm 5.12; Gn 3.6.",
  },
  question14: {
    id: 14,
    question: "PERGUNTA 14. Que é pecado?",
    answer:
      "R. Pecado é qualquer falta de conformidade com a lei de Deus, ou qualquer transgressão desta lei.",
    references: "Ref. Tg 2.10; 4.17; 1Jo 3.4.",
  },
  question15: {
    id: 15,
    question:
    ...
    references: "Ref. Gn 3.12-13; Os 6.7.",
  },
  question16: {
    id: 16,
    question:
    ...
    references: "Ref. Gn 1.28; At 17.26; 1Co 15.21-22; Rm 5.12-14.",
  },
  question17: {
    id: 17,
    question:
  ...
  question18: {
    ...
    references: "Ref. Rm 5.18-19; Ef 2.1-3; Rm 8.7-8; Sl 51.5.",
  },
  question19: {
    id: 19,
    question: "PERGUNTA 19. Qual é a miséria do estado em que o homem caiu?",
    answer:
    ...
    references: "Ref. Gn 3.8, 24; Ef 2.3; Rm 6.23; Mt 25.41-46.",
  },
  question20: {
    id: 20,
    question:
    ...
    references: "Ref. Ef 1.4; Tt 1.2; 3.4-7; Jo 17.6.",
  },
  question21: {
    id: 21,
    question: "PERGUNTA 21. Quem é o Redentor dos escolhidos de Deus?",
    answer:
    ...
    references: "Ref. 1Tm 2.5; Jo 1.14; Rm 9.5; Cl 2.9; Hb 13.8.",
  },
  question22: {
    id: 22,
    question: "PERGUNTA 22. Como Cristo, sendo o Filho de Deus, se fez homem?",
    answer:
    ...
    references: "Ref. Hb 2.14; Mt 26.38; Lc 2.52; 1.31, 35; Hb 4.15.",
  },
  question23: {
    id: 23,
    question: "PERGUNTA 23. Que funções exerce Cristo como nosso Redentor?",
    answer:
    ...
    references: "Ref. At 3.22; Hb 5.5-6; Sl 2.6; Jo 1.49.",
  },
  question24: {
    id: 24,
    question: "PERGUNTA 24. Como exerce Cristo as funções de profeta?",
    answer:
    ...
    references: "Ref. Jo 1.18; Hb 1.1-2; Jo 14.26; 16.13.",
  },
  question25: {
    id: 25,
    question: "PERGUNTA 25. Como exerce Cristo as funções de sacerdote?",
    answer:
    ...
    references: "Ref. Hb 9.28; Rm 3.24-26; 10.4; Hb 2.17; 7.25; Is 53.12.",
  },
  question26: {
    id: 26,
    question: "PERGUNTA 26. Como exerce Cristo as funções de rei?",
    answer:
    ...
    references: "Ref. Sl 110.3; At 2.36; 18.9-10; Is 9.6-7; 1Co 15.26-27.",
  },
  question27: {
    id: 27,
    question: "PERGUNTA 27. Em que consistiu a humilhação de Cristo?",
    answer:
  ...
  question28: {
    id: 28,
    question: "PERGUNTA 28. Em que consiste a exaltação de Cristo?",
    answer:
    ...
    references: "Ref. 1Co 15.4; Ef 1.20-21; At 17.31.",
  },
  question29: {
    id: 29,
    question:
    ...
    references: "Ref. Jo 1.12; 3.5-6; Tt 3.5-6.",
  },
  question30: {
    id: 30,
    question:
    ...
    references: "Ref. Gl 2.20; Ef 2.8; 1Co 12.12-13.",
  },
  question31: {
    id: 31,
    question: "PERGUNTA 31. Que é vocação eficaz?",
    answer:
  ...
  question32: {
    ...
    references: "Ref. Rm 8.30; Ef 1.5; 1Co 1.30.",
  },
  question33: {
    id: 33,
    question: "PERGUNTA 33. Que é justificação?",
    answer:
    ...
    references: "Ref. Ef 1.7; 2Co 5.21; Rm 4.6; 5.18; Gl 2.16.",
  },
  question34: {
    id: 34,
    question: "PERGUNTA 34. Que é adoção?",
    answer:
    ...
    references: "Ref. 1Jo 3.1; Jo 1.12; Rm 8.14-17.",
  },
  question35: {
    id: 35,
    question: "PERGUNTA 35. Que é santificação?",
    answer:
    ...
    references: "Ref. 1Pe 1.2; Ef 4.20-24; Rm 6.6; 12.1-2.",
  },
  question36: {
    id: 36,
    question:
    ...
    references: "Ref. Rm 5.1-5; 14.17; Jo 1.16; Fp 1.6; 1Pe 1.5.",
  },
  question37: {
    id: 37,
    question:
  ...
  question38: {
    ...
    references: "Ref. 1Co 15.43; Mt 10.32; 25.34; Sl 16.11.",
  },
  question39: {
    id: 39,
    question: "PERGUNTA 39. Qual é o dever que Deus exige do homem?",
    answer:
      "R. O dever que Deus exige do homem é obediência à sua vontade revelada.",
    references: "Ref. Mq 6.8; Lc 10.27-28; Gn 17.1.",
  },
  question40: {
    id: 40,
    question:
    ...
    references: "Ref. Rm 2.14-15.",
  },
  question41: {
    id: 41,
    question: "PERGUNTA 41. Onde está a lei moral resumidamente compreendida?",
    answer:
      "R. A lei moral está resumidamente compreendida nos dez mandamentos.",
    references: "Ref. Dt 10.4; Mt 19.17-19.",
  },
  question42: {
    id: 42,
    question: "PERGUNTA 42. Em que se resumem os dez mandamentos?",
    answer:
    ...
    references: "Ref. Mt 22-37-40.",
  },
  question43: {
    id: 43,
    question: "PERGUNTA 43. Qual é o prefácio dos dez mandamentos?",
    answer:
      'R. O prefácio dos dez mandamentos é: "Eu sou o Senhor teu Deus, que te tirei da terra do Egito, da casa da servidão".',
    references: "Ref. Ex 20.2.",
  },
  question44: {
    id: 44,
    question: "PERGUNTA 44. Que nos ensina o prefácio dos dez mandamentos?",
    answer:
    ...
    references: "Ref. Dt 11.1; 1Pe 1.15-19.",
  },
  question45: {
    id: 45,
    question: "PERGUNTA 45. Qual é o primeiro mandamento?",
    answer:
      'R. O primeiro mandamento é: "Não terás outros deuses além de mim".',
    references: "Ref. Ex 20.3.",
  },
  question46: {
    id: 46,
    question: "PERGUNTA 46. Que exige o primeiro mandamento?",
    answer:
    ...
    references: "Ref. 1Cr 28.9; Dt 26.17; Sl 95.6-7.",
  },
  question47: {
    id: 47,
    question: "PERGUNTA 47. Que proíbe o primeiro mandamento?",
    answer:
    ...
    references: "Ref. Sl 14.1; Rm 1.20-21, 25; Sl 8.11.",
  },
  question48: {
    id: 48,
    question:
    ...
    references: "Ref. Sl 139.1-3; Dt 30.17-18.",
  },
  question49: {
    id: 49,
    question: "PERGUNTA 49. Qual é o segundo mandamento?",
    answer:
    ...
    references: "Ref. Ex 20.4-6.",
  },
  question50: {
    id: 50,
    question: "PERGUNTA 50. Que exige o segundo mandamento?",
    answer:
    ...
    references: "Ref. Dt 12.32; Mt 28.20; Jo 4.23-24.",
  },
  question51: {
    id: 51,
    question: "PERGUNTA 51. Que proíbe o segundo mandamento?",
    answer:
    ...
    references: "Ref. Rm 1.22-23; 2Rs 18.3-4.",
  },
  question52: {
    id: 52,
    question: "PERGUNTA 52. Quais são as razões anexas ao segundo mandamento?",
    answer:
    ...
    references: "Ref. Sl 45.11; 100.3; Ex 34.14; 1Co 10.22.",
  },
  question53: {
    id: 53,
    question: "PERGUNTA 53. Qual é o terceiro mandamento?",
    answer:
    ...
    references: "Ref. Ex 20.7.",
  },
  question54: {
    id: 54,
    question: "PERGUNTA 54. Que exige o terceiro mandamento?",
    answer:
      "R. O terceiro mandamento exige o santo e reverente uso dos nomes, títulos, atributos, ordenanças, palavras e obras de Deus.",
    references: "Ref. Sl 29,2; Ap 15.3-4; Ec 5.1; Sl 138.2; 104.24.",
  },
  question55: {
    id: 55,
    question: "PERGUNTA 55. O que proíbe o terceiro mandamento?",
    answer:
      "R. O terceiro mandamento proíbe toda a profanação ou abuso das coisas por meio das quais Deus se faz conhecer.",
    references: "Ref. Lv 19.12; Mt 5.34-35.",
  },
  question56: {
    id: 56,
    question: "PERGUNTA 56. Qual é a razão anexa ao terceiro mandamento?",
    answer:
    ...
    references: "Ref. Dt 28.58-59.",
  },
  question57: {
    id: 57,
    question: "PERGUNTA 57. Qual é o quarto mandamento?",
    answer:
    ...
    references: "Ref. Ex 20. 8.11.",
  },
  question58: {
    id: 58,
    question: "PERGUNTA 58. Que exige o quarto mandamento?",
    answer:
    ...
    references: "Ref. Lv 19.30; Dt 5.12.",
  },
  question59: {
    id: 59,
    question:
    ...
    references: "Ref. Gn 2.3; Ex 16.23; At 20.7; 1Co 16.1-2; Ap 1.10.",
  },
  question60: {
    id: 60,
    question: "PERGUNTA 60. De que modo se deve santificar o Domingo?",
    answer:
    ...
    references: "Ref. Lv 23.3; Is 58.13-14; Mt 12.11-12; Mc 2.27-28.",
  },
  question61: {
    id: 61,
    question: "PERGUNTA 61. Que proíbe o quarto mandamento?",
    answer:
    ...
    references: "Ref. Jr 17.21; Lc 23.56.",
  },
  question62: {
    id: 62,
    question: "PERGUNTA 62. Quais são as razões anexas ao quarto mandamento?",
    answer:
    ...
    references: "Ref. Ex 31. 15-16; Lv 23.3; Ex 31.17; Gn 2.3.",
  },
  question63: {
    id: 63,
    question: "PERGUNTA 63. Qual é o quinto mandamento?",
    answer:
    ...
    references: "Ref. Ex 20.12.",
  },
  question64: {
    id: 64,
    question: "PERGUNTA 64. Que exige o quinto mandamento?",
    answer:
    ...
    references: "Ref. Ef 6.1-3; Rm 13.1-2; 12.10.",
  },
  question65: {
    id: 65,
    question: "PERGUNTA 65. Que proíbe o quinto mandamento?",
    answer:
    ...
    references: "Ref. Rm 13.7-8.",
  },
  question66: {
    id: 66,
    question: "PERGUNTA 66. Qual é a razão anexa ao quinto mandamento?",
    answer:
    ...
    references: "Ref. Ef 6.2-3.",
  },
  question67: {
    id: 67,
    question: "PERGUNTA 67. Qual é o sexto mandamento?",
    answer: 'R. O sexto mandamento é: "Não matarás".',
    references: "Ref. Ex 20.13.",
  },
  question68: {
    id: 68,
    question: "PERGUNTA 68. Que exige o sexto mandamento?",
    answer:
      "R. O sexto mandamento exige todos os esforços lícitos para conservar a nossa vida e a dos nossos semelhantes.",
    references: "Ref. Sl 132.3-4; At 27.33-34; Rm 12.20-21; Lc 10.33-37.",
  },
  question69: {
    id: 69,
    question: "PERGUNTA 69. Que proíbe o sexto mandamento?",
    answer:
    ...
    references: "Ref. At 16.28; Gn 9.6; Dt 24.6; Pv 24.11-12; 1Jo 3.15.",
  },
  question70: {
    id: 70,
    question: "PERGUNTA 70. Qual é o sétimo mandamento?",
    answer: 'R. O sétimo mandamento é: "Não adulterarás"',
    references: "Ref. Ex 24.14.",
  },
  question71: {
    id: 71,
    question: "PERGUNTA 71. Que exige o sétimo mandamento?",
    answer:
    ...
    references: "Ref. 1Ts 4.4; Ef 4.29; 5.11-12; 1Pe 3.2.",
  },
  question72: {
    id: 72,
    question: "PERGUNTA 72. Que proíbe o sétimo mandamento?",
    answer:
      "R. O sétimo mandamento proíbe todos os pensamentos, palavras e ações impuras.",
    references: "Ref. Mt 5.28; Ef 5.3-4.",
  },
  question73: {
    id: 73,
    question: "PERGUNTA 73. Qual é o oitavo mandamento?",
    answer: 'R. O oitavo mandamento é: "Não furtarás".',
    references: "Ref. Ex 20.15.",
  },
  question74: {
    id: 74,
    question: "PERGUNTA 74. Que exige o oitavo mandamento?",
    answer:
    ...
    references: "Ref. Pv. 27.23; 22.1-14; Fl 2.4; Ex 23.4-6.",
  },
  question75: {
    id: 75,
    question: "PERGUNTA 75. Que proíbe o oitavo mandamento?",
    answer:
    ...
    references: "Ref. Pv 28.19; 1Tm 5.8; Tg 5.1-4.",
  },
  question76: {
    id: 76,
    question: "PERGUNTA 76. Qual é o nono mandamento?",
    answer:
      'R. O nono mandamento é: "Não dirás falso testemunho contra o teu próximo".',
    references: "Ref. Ex 20.16.",
  },
  question77: {
    id: 77,
    question: "PERGUNTA 77. Que exige o nono mandamento?",
    answer:
  ...
  question78: {
    id: 78,
    question: "PERGUNTA 78. Que proíbe o nono mandamento?",
    answer:
    ...
    references: "Ref. Cl 3.9; 2Co 8.20-21; Sl 15.3; 12.3.",
  },
  question79: {
    id: 79,
    question: "PERGUNTA 79. Qual é o décimo mandamento?",
    answer:
    ...
    references: "Ref. Ex 20.17.",
  },
  question80: {
    id: 80,
    question: "PERGUNTA 80. Que exige o décimo mandamento?",
    answer:
    ...
    references: "Ref. Hb 13.5; 1Tm 6.6-10; Lv 19.18; 1Co 13.4-6.",
  },
  question81: {
    id: 81,
    question: "PERGUNTA O que proíbe o décimo mandamento?",
    answer:
    ...
    references: "Ref. 1Co 10.10; Gl 5.26; Cl 3.5; 1Tm 6.6-10.",
  },
  question82: {
    id: 82,
    question:
    ...
    references: "Ref. Rm 3.9-10; Tg 3.2.",
  },
  question83: {
    id: 83,
    question:
    ...
    references: "Ref. Sl 19.13; Mt 11.24; Lc 12.10; Hb 2.2-3.",
  },
  question84: {
    id: 84,
    question: "PERGUNTA 84. Que merece cada pecado?",
    answer:
      "R. Cada pecado merece a ira e a maldição de Deus, tanto nesta vida como na vindoura.",
    references: "Ref. Gl 3.10; Tg 2.10; Mt 25.41.",
  },
  question85: {
    id: 85,
    question:
    ...
    references: "Ref. At 20.21; 2Pe 1.10; Hb 2.3; 1Tm 4.16.",
  },
  question86: {
    id: 86,
    question: "PERGUNTA 86. Que é fé em Jesus Cristo?",
    answer:
    ...
    references: "Ref. At 16.31; Hb 10.39; Jo 1.12; Fp 3.9; Ap 22.17.",
  },
  question87: {
    id: 87,
    question: "PERGUNTA 87. Que é arrependimento para a vida?",
    answer:
    ...
    references: "Ref. 2Co 7.10; At 2.37; Lc 1.77-79; Jr 31.18-19; Rm 6.18.",
  },
  question88: {
    id: 88,
    question:
    ...
    references: "Ref. At 2.41-42.",
  },
  question89: {
    id: 89,
    question: "PERGUNTA 89. Como se torna a Palavra eficaz para a salvação?",
    answer:
    ...
    references: "Ref. Ne 8.8; At 20.32; Rm 15.4; 2Tm 3.15;.",
  },
  question90: {
    id: 90,
    question:
  ...
  question91: {
    ...
    references: "Ref. 1Pe 3.21; Rm 2.28-29; 1Co 12.13; 10.16-17.",
  },
  question92: {
    id: 92,
    question: "PERGUNTA 92. Que é um sacramento?",
    answer:
    ...
    references: "Ref. Mt 26.26-28; 28.19; Rm 4.11.",
  },
  question93: {
    id: 93,
    question: "PERGUNTA 93. Quais são os sacramentos do Novo Testamento?",
    answer:
      "R. Os sacramentos do Novo Testamento são o Batismo e a Ceia do Senhor.",
    references: "Ref. At 10.47-48; 1Co 11.23-26.",
  },
  question94: {
    id: 94,
    question: "PERGUNTA 94. Que é o Batismo?",
    answer:
    ...
    references: "Ref. Mt 28.19; Jo 3.5; Rm 6.1-11; Gl 3.27.",
  },
  question95: {
    id: 95,
    question: "PERGUNTA 95. A quem deve ser ministrado o Batismo?",
    answer:
    ...
    references: "Ref. At 18.8; Gn 17.7-14; At 2.38-39; 1Co 7.14.",
  },
  question96: {
    id: 96,
    question: "PERGUNTA 96. O que é a Ceia do Senhor?",
    answer:
    ...
    references: "Ref. 1Co 11.23-26; At 3.21; 1Co 10.16.",
  },
  question97: {
    id: 97,
    question:
    ...
    references: "Ref. 1Co 11.27; 31-32; Rm 6.17-18.",
  },
  question98: {
    id: 98,
    question: "PERGUNTA 98. O que é Oração?",
    answer:
    ...
    references: "Ref. Sl 10.17; 145.19; 1Jo 5.14; 1.9; Jo 16.23-24; Fp 4.6.",
  },
  question99: {
    id: 99,
    question:
    ...
    references: "Ref. Rm 8.26; Sl 119.170; Mt 6.9-13.",
  },
  question100: {
    id: 100,
    question: "PERGUNTA 100. Que nos ensina o prefácio da Oração Dominical?",
    answer:
    ...
    references: "Ref. Lc 11.13; Rm 8.15; 1Tm 2.1-2.",
  },
  question101: {
    id: 101,
    question: "PERGUNTA 101. Pelo que oramos na primeira petição?",
    answer:
    ...
    references: "Ref. Sl 67.1-3; Rm 11.36; Ap 4.11.",
  },
  question102: {
    id: 102,
    question: "PERGUNTA 102. Pelo que oramos na segunda petição?",
    answer:
  ...
  question103: {
    id: 103,
    question: "PERGUNTA 103. Pelo que oramos na terceira petição?",
    answer:
    ...
    references: "Ref. Mt 24.39; Fp 1.9-11; Sl 103.20-21.",
  },
  question104: {
    id: 104,
    question: "PERGUNTA 104. Pelo que oramos na quarta petição?",
    answer:
    ...
    references: "Ref. Pv 30.8-9; 1Tm 6.6-8; Pv 10.22.",
  },
  question105: {
    id: 105,
    question: "PERGUNTA 105. Pelo que oramos na quinta petição?",
    answer:
    ...
    references: "Ref. Sl 51.1-2, 7; Mt 18.35.",
  },
  question106: {
    id: 106,
    question: "PERGUNTA 106. Pelo que oramos na sexta petição?",
    answer:
    ...
    references: "Ref. Mt 26.41; Sl 19.13; Jo 17.15; 1Co 10.13.",
  },
  question107: {
    id: 107,
    question: "PERGUNTA 107. Que nos ensina a conclusão da Oração Dominical?",
    answer:
